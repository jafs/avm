...
Public Class frmPrincipal
    ...
    Private Sub getBateria()
        ...
        ' TODO sResultado = sResultado.Replace(vbCr & "" & vbCrLf, vbNewLine)
        bModoConsulta = True
    ...
    ''' <param name="sender">Emisor del evento</param>
    ''' <param name="e">Datos del evento</param>
    Private Sub chkGsmTimer_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkGsmTimer.CheckedChanged
    ...
    ''' <param name="sender">Emisor del evento</param>
    ''' <param name="e">Datos del evento</param>
    Private Sub btnGsmCall_Click(sender As System.Object, e As System.EventArgs) Handles btnGsmCall.Click
        Dim sNumero As String = Nothing
        Dim bValido As Boolean = True
        ...
        If bValido Then
            ...
            If Integer.TryParse(txtGsmNumero.Text, iNumero) Then
                ...
                sNumero &= iNumero
                enviarComando(Comando.GSM_CALL & sNumero)
    ...
    ''' <param name="sender">Emisor del evento</param>
    ''' <param name="e">Datos del evento</param>
    Private Sub tmrGsm_Tick(sender As System.Object, e As System.EventArgs) Handles tmrGsm.Tick
        actualizarLlamadas()
    End Sub
    ...
    Private Sub actualizarLlamadas()
        Dim sResultado As String = objTelnet.consultar(Comando.GSM_LIST)
    ...
    ''' <param name="sender">Emisor del evento</param>
    ''' <param name="e">Datos del evento</param>
    Private Sub dgvGsmLlamadas_CellClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvGsmLlamadas.CellClick
            ...
            Select Case e.ColumnIndex
                Case 5
                    ...
                    If sEstado = Llamada.EstadoLlamada.active.ToString Then
                        enviarComando(Comando.GSM_HOLD & sNumero)
                    ElseIf sEstado = Llamada.EstadoLlamada.held.ToString Then
                        enviarComando(Comando.GSM_ACCEPT & sNumero)
                    End If

                Case 6
                    ' Botón ocupado
                    If dgvGsmLlamadas.Rows(iFila).Cells(3).Value.ToString = Llamada.TipoLlamada.outbound.ToString Then
                        enviarComando(Comando.GSM_BUSY & sNumero)
                    End If

                Case 7
                    ' Botón cancelar
                    enviarComando(Comando.GSM_CANCEL & sNumero)
            End Select
        End If
    End Sub
End Class
